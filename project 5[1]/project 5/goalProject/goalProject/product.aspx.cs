    ...
    public partial class product : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con2 = new SqlConnection("data source=  DESKTOP-TCARVN7\\SQLEXPRESS; database=goalProject; integrated security=SSPI");
                // writing sql query  
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            if (Session["name"] != null)
            {
                ...
                try
                {
                    // Creating Connection  
                    con = new SqlConnection("data source = DESKTOP-TCARVN7\\SQLEXPRESS; database=goalProject; integrated security=SSPI");
                    con1 = new SqlConnection("data source = DESKTOP-TCARVN7\\SQLEXPRESS; database=goalProject; integrated security=SSPI");
                    con2 = new SqlConnection("data source = DESKTOP-TCARVN7\\SQLEXPRESS; database=goalProject; integrated security=SSPI");
